...
jQuery(document).ready(function() {
	...
	jQuery(".quantity-btns .add").each(tamaar.ui.qty.bindQtyPlus);
	
	//bind the qty minus button behaviour to each TMAPI-subtract button on the page.
	jQuery(".quantity-btns .subtract").each(tamaar.ui.qty.bindQtyMinus);
	
	//bind the qty input behaviour to each TMAPI-qty input on the page.
	jQuery(".quantity-btns .quantity-box").each(tamaar.ui.qty.bindQtyInput);
