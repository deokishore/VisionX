            ...
            <div id="product">
            	<div class="row">
                	<div class="checkout checkout-step2 span12">
                    	<h1 class="pb15">Checkout - Edit Billing Address</h1>
                        <div class="address-fields">
                            ...
                            <div class="head">
            					<h2>Checkout - Edit Billing Address</h2> 
        					</div>
                                    	...
                                    	<table class="create_new_account">
                                        	<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" value="Flat 1" name="addressField1" id="addressField1" class="text" required>
                                                        <span class="required">*</span>
                                                 	</td>
                                                </tr>
                                                <tr>
                                    	...
                                    	<table>
                                        	<tbody>
                                            	<tr>
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" id="telephone" class="text" value="7655465342"  name="telephone" pattern="\+?[0-9]{10,20}">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
