     ...
     <!-- Begin content-->
   	<section id="content" class="row clearfix pb15"> 
           		...
           		<ul id="left-hand-nav">
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="/newAddress" id="side-nav-add_new_address" class="current">Add a new address</a>
                                </li>
                                <li>
           ...
           <!-- End Side Bar Left -->
            ...
            <!-- Order Summary -->
            	<div class="account-create my-account span9">
                    	<h1 class="pb15">Add New Address</h1>
                        <div class="address-fields">
                            <div class="head">
            					<h2>Add New Address</h2> 
        					</div>
                            <div class="checkout-text span9">
            					<p>
                            ...
                            <div id="login" class="new-address">
                                ...
                                <label for="primary_billing">Use this address as my default billing address</label>
                                </li>
                        					<li>
                                            	<input type="checkbox" class="checkbox" value="1" name="default_shipping" id="primary_shipping">
                                <label for="primary_shipping">Use this address as my default delivery address</label>
                                            </li>
                    					</ul>
                                    </div>
