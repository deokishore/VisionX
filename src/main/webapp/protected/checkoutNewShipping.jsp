            ...
            <div id="product">
            	<div class="row">
                	<div class="checkout checkout-step2 span12">
                    	<h1 class="pb15">Checkout - Add New Delivery Address</h1>
                        <div class="address-fields">
                        	<div class="progress-bar clearfix">
                            	<ol>
                                    ...
                                    <li class="current" id="delivery-progress-bar">
                						<h4><a href="/billingDeliveryInfo">Billing &amp; delivery</a></h4>
            						</li>
                            ...
                            <div class="head">
            					<h2>Checkout - Add New Delivery Address</h2> 
        					</div>
                            ...
                            <div id="login" class="new-address span11">
                            	<form id="addressForm" method="post" action="/billingDeliveryInfo">
                                    	...
                                    	<table class="create_new_account">
                                        	<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" value="" name="addressField1" id="addressField1" class="text" required>
                                                        <span class="required">*</span>
                                                 	</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" value="" name="addressField2" id="addressField2" class="text">
                                                 	</td>
                                                </tr>
                                                <tr>
                                                	<td class="label">
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" value="" name="addressField3" id="addressField3" class="text">
                                                 	</td>
                                                </tr>
                                                <tr>
                                                	<td class="label">
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" value="" name="cityField" id="cityField" class="text" required>
                                                        <span class="required">*</span>
                                                 	</td>
                                                </tr>
                                                <tr>
                                               	...
                                               	<tr>
                                                    ...
                                                    <td class="value">
                                                    	<input type="text" value="" name="postalCode" id="postalCode" class="text" required pattern="\+?[0-9, A-Z]{3,12}">
                                                        <span class="required">*</span>
                                                 	</td>
                                             	</tr>
                                            </tbody>
                                    ...
                                    <div class="span6">
                                        ...
                                        <ul class="radio-btn-list stylenone pt20">
                        					<li>
                                           		<input type="checkbox" class="checkbox" value="1" name="default_billing" id="primary_billing">
                                				<label for="primary_billing">Use this address as my default billing 
                                                address</label>
                                          	</li>
                        					<li>
                                                <input type="checkbox" class="checkbox" value="1" name="default_shipping" id="primary_shipping">
                                				<label for="primary_shipping">Use this address as my default delivery 
                                                address</label>
                                            </li>
                    					</ul>
                                    </div>
                                  ...
                                  <input type="button" onclick="location.href='/billingDeliveryInfo'" value="Cancel" class="btn">
